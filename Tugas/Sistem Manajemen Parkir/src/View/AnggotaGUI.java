...
public class AnggotaGUI {
   private static AnggotaController siswa = new AnggotaController();
   ...
   JComboBox pil = new JComboBox(KategoriEntity.kategoripilkend);
   int index;
    ...
    public AnggotaGUI(){
        ...
        Anggota.getContentPane().setBackground(Color.PINK);
            ...
            anggota =new JLabel("MENU ANGGOTA");
