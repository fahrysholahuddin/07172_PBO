...
import Model.DaftarKendaraanSiswaModel;
...
public class Main {
    ...
    private static SiswaModel siswaModel = new SiswaModel();
    private static DaftarKendaraanSiswaModel daftarKendaraanModel = new DaftarKendaraanSiswaModel();
    ...
    public static void main (String[] args) {
        ...
        static void dataAdmin(){
            ...
            for (int i = 0; i<noAdmin.length ; i++){
                adminModel.insertAdmin(new AdminEntity(noAdmin [i], passwordAdmin[i],namaAdmin[i],notelpAdmin[i],statusAdmin[i],new Date (tglLahir[i])));
                }
            }
        static void register (){
            ...
            siswaModel.insert(new SiswaEntity(no,pass,nama,notelp,status,tanggal));
        ...
        static void login (){
            ...
            if(cekData == -1){
                ...
                System.out.println("Merk = "+KendaraanEntity.merk[daftarKendaraanModel.showDaftarKendaraan(cekSiswa).getIndexKendaraan()]);
        ...
        static void daftarMerk(){
            ...
            for (int i= 0; i<KendaraanEntity.merk.length;i++){
                System.out.println(i+". "+KendaraanEntity.merk[i]);
            }
            System.out.print("Pilih Merk = ");
                pilMerk = input.nextInt();
            daftarKendaraanModel.insertDataDaftarKendaraan(new DaftarKendaraanSiswaEntity(pilMerk,siswaModel.getSiswaEntityArrayList(cekSiswa),false));
        }
        ...
        static void updateIsverified (){
            ...
            daftarKendaraanModel.updateIsVerified(index, new DaftarKendaraanSiswaEntity(pilMerk,siswaModel.getSiswaEntityArrayList(index),true));            
        }
    }
