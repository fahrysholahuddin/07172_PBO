...
public class AnggotaController {
    AnggotaModel siswa_m = new AnggotaModel();
    int indexLogin = 0;
     
 public ArrayList<AnggotaEntity> getListSiswa(){
       return siswa_m.getAnggota();
    }
 public AnggotaEntity getData(){
     return getData();
 }
 ...
 public DefaultTableModel listkendaraan(){
    ...
    for (int i=0; i<size; i++){
        ...
        kendaraan[0] = KategoriEntity.kategoripilkend[allobjctrl.kendaraan.getListKendaraan().get(i).getIndexpilkend()];
    ...
    public void insertSiswa(String no,String nama, String alamat, String no_telp, 
        ...
        AnggotaEntity data = new AnggotaEntity();
        data.setNo(no);
        data.setNama(nama);
    ...
    public AnggotaEntity siswaEntity(){
        return
